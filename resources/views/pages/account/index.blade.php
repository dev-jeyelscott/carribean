        ...
        <div class="public-container">
            <div class="max-w-3xl">
                ...
                <p
                    class="mt-5 max-w-2xl text-base leading-8
                        text-brand-muted">
                    Manage your contact details now. Your current and previous
                    orders will appear here after checkout is introduced in the
            ...
            <div class="mt-8 grid gap-6 lg:grid-cols-2">
                <article
                    ...
                    <p class="public-eyebrow">Profile</p>
                    ...
                    <p class="mt-4 leading-7 text-brand-muted">
                        Your name, email address, and phone number will be
                        available to prefill the checkout form.
                    </p>
                ...
                <article
                    ...
                    <p class="mt-4 leading-7 text-brand-cream/70">
                        Once checkout is available, placed orders and their
                        statuses will appear in this account.
                    </p>
