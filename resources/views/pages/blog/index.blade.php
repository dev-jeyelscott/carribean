@php
    /*
     * The latest published post receives the featured editorial treatment.
     */
            ...
            <div class="public-container relative z-10">
                <div
                    ...
                    <div
                        ...
                        <h1
                            class="mt-6 font-display text-5xl
                        ...
                        <p
                            ...
                            Notes from the kitchen, the people behind the
                            plates, and the Caribbean traditions that shape
                        ...
                        <div class="journal-hero-orbit">
                            ...
                            <div class="journal-hero-orbit__card">
                                ...
                                <p
                                    ...
                                    Food, place, memory, and an open seat at
                                    the table.
                                </p>

                                <div
                                    class="mt-6 h-px bg-white/16">
                                </div>
                ...
                <div class="public-container">
                    <div
                        ...
                        class="mx-auto max-w-2xl rounded-[2.5rem]
                            border border-primary/10 bg-surface p-10
                            text-center shadow-panel sm:p-14">
                        ...
                        <p
                            class="mx-auto mt-6 max-w-xl leading-8
                                text-muted">
                            Until then, explore the menu and discover the
                            dishes currently being served.
                        </p>
                ...
                <div class="public-container">
                    <article class="journal-feature-card">
                        ...
                        <div
                            ...
                            <h2
                                class="mt-5 font-display text-4xl
                                    leading-[1.02] text-primary-deep
                                    sm:text-5xl">
                                <a
                                    href="{{ route(
                                        'blog.show',
                            ...
                            @if ($featuredPost->excerpt)
                                <p
                                    class="mt-6 text-base leading-8
                                        text-muted">
                            ...
                            <a
                                ...
                                class="mt-8 inline-flex items-center
                                    ...
                                    transition hover:text-primary-deep">
                                Read the Story
                ...
                <section
                    ...
                    <div class="public-container">
                        <div
                            ...
                            <p
                                class="mt-5 max-w-2xl leading-8
                                    text-muted">
