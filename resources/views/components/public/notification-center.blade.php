<div
    ...
    class="pointer-events-none fixed inset-x-4 top-24 z-[60]
    ...
    <div
        ...
        x-ref="notification"
        tabindex="-1"
        class="pointer-events-auto w-full border p-5 text-sm
            leading-7 shadow-[0_20px_60px_rgba(23,25,22,0.2)]"
        :class="notification?.type === 'success'
            ? 'border-emerald-700/25 bg-emerald-50 text-emerald-900'
            : 'border-brand-burgundy/25 bg-red-50 text-brand-burgundy'"
        :role="notification?.type === 'success'
            ? 'status'
            : 'alert'"
        :aria-live="notification?.type === 'success'
            ? 'polite'
            : 'assertive'"
        aria-atomic="true">
